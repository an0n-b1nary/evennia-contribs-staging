...
"""
ScenesAuthoringMixin — shared base for evennia_scenes write views.
...
from evennia_scenes.permissions import require_character


class ScenesAuthoringMixin(LoginRequiredMixin):
    """Mixin for all evennia_scenes authoring (write) views.
    ...
    def get_permission_target(self):
        ...
        For edit views this is typically the entry being edited. Override in
        subclasses.
        """
        return None
