...
"""AuthoringMixin for evennia_plots write views (create, edit, update)."""

from django.contrib.auth.mixins import LoginRequiredMixin
from django.core.exceptions import PermissionDenied

from evennia_plots.permissions import is_staff_user, require_character


class AuthoringMixin(LoginRequiredMixin):
    """Mixin for all evennia_plots authoring (write) views."""
